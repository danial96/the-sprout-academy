...
Route::middleware(['auth', 'verified', 'admin'])->prefix('admin')->name('admin.')->group(function () {
    ...
    Route::controller(FormDataController::class)->prefix('forms')->name('forms.')->group(function () {
        ...
        Route::get('/suggestions/{id}', 'suggestionShow')->name('suggestions.show');
        ...
        Route::get('/time-clock-change-requests/{id}', 'timeClockChangeRequestShow')->name('time-clock-change-requests.show');
        ...
        Route::get('/time-off-requests/{id}', 'timeOffRequestShow')->name('time-off-requests.show');
        ...
        Route::get('/standard-t-shirt-orders/{id}', 'standardTShirtOrderShow')->name('standard-t-shirt-orders.show');
        ...
        Route::get('/specialty-t-shirt-orders/{id}', 'specialtyTShirtOrderShow')->name('specialty-t-shirt-orders.show');
        ...
        Route::get('/supply-orders/{id}', 'supplyOrderShow')->name('supply-orders.show');
        ...
        Route::get('/snack-orders/{id}', 'snackOrderShow')->name('snack-orders.show');
        ...
        Route::get('/child-absent-forms/{id}', 'childAbsentFormShow')->name('child-absent-forms.show');
        ...
        Route::get('/employment-applications/{id}', 'employmentApplicationShow')->name('employment-applications.show');
