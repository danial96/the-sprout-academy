...
@section('content')
    ...
    <section class="steps-section section" aria-labelledby="steps-heading">
        <div class="container">
            ...
            <div class="steps-cta">
                ...
                <a href="{{ route('frontend.enroll') }}" class="btn btn-tour-outline btn-lg">Schedule a Tour
                    &raquo;</a>
            </div>
        </div>
    </section>
        ...
        <div class="container">
            ...
            <div class="row align-items-center">
                <div class="col-lg-5 mb-4 mb-lg-0">
                    ...
                    <a href="{{ route('frontend.enroll') }}" class="btn btn-foundation btn-lg mt-3">Schedule a Tour
                        &raquo;</a>
                </div>
                <div class="col-lg-7">
    ...
    <!-- Spots Are Limited / Locations Slider Section -->
    <section class="locations-slider-section section" aria-labelledby="locations-heading">
        <div class="container">
                            ...
                            <div class="location-slide">
                                <div class="location-slide-inner">
                                    ...
                                    <div class="location-slide-bar">
                                        ...
                                        @if($location->phone)
                                            <span class="location-slide-address">
                                                <span class="loc-pin-icon"><i class="fas fa-phone"></i></span>
                                                {{ $location->phone }}
                                            </span>
                                        @endif
