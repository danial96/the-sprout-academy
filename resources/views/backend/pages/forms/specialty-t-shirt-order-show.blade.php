...
@section('title', 'Specialty T-Shirt Order Details')
@section('content')
    <h1 class="mt-4">Specialty T-Shirt Order #{{ $order->id }}</h1>
    <ol class="breadcrumb mb-4">
        <li class="breadcrumb-item"><a href="{{ route('admin.dashboard') }}">Dashboard</a></li>
        <li class="breadcrumb-item"><a href="{{ route('admin.forms.specialty-t-shirt-orders') }}">Specialty T-Shirt Orders</a></li>
    ...
    <div class="mb-4">
        <a href="{{ route('admin.forms.specialty-t-shirt-orders') }}" class="btn btn-secondary"><i class="fas fa-arrow-left"></i> Back to List</a>
    </div>
@endsection
