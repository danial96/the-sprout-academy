...
@section('content')
    <h1 class="mt-4">Supply Order #{{ $order->id }}</h1>
    <ol class="breadcrumb mb-4">
        <li class="breadcrumb-item"><a href="{{ route('admin.dashboard') }}">Dashboard</a></li>
        <li class="breadcrumb-item"><a href="{{ route('admin.forms.supply-orders') }}">Supply Orders</a></li>
    ...
    <div class="card mb-4">
        <div class="card-header"><i class="fas fa-boxes me-1"></i> Order Items</div>
        <div class="card-body">
    ...
    <div class="mb-4">
        <a href="{{ route('admin.forms.supply-orders') }}" class="btn btn-secondary"><i class="fas fa-arrow-left"></i> Back to List</a>
    </div>
@endsection
